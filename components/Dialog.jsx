                ...
                <div className="mt-4">
                  ...
                  <div className="flex items-center mt-2 -mx-1">
                    <input
                      type="text"
                      value={link}
                      className="flex-1 block h-10 px-4 mx-1 text-sm text-gray-700 bg-white border border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring"
                    />
                    <button
                      onClick={copyToClipboard}
                      className="hidden mx-1 text-gray-600 transition-colors duration-300 sm:block  hover:text-blue-500 "
                    >
                      <svg
